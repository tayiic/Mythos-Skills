...
**前 100 名 stargazer 专享：**
- 免费 1 对 1 AI coding 工作流咨询
- 新 skill 优先体验权
- 直接向维护者提问（X 私信或 GitHub Discussion）

⭐ 点亮 star → 在 [X](https://x.com/tayiic) 私信我领取

## 🎯 Star 里程碑

| Stars | 解锁内容 |
|-------|---------|
| 100 | `skill-creator-lite` 单文件版 |
| 500 | P1-P8 实战视频 walkthrough |
| 1,000 | `plan-forge` skill（Tier 1，优先体验） |
| 2,500 | 中文深度系列（8 篇） |
| 5,000 | 公开 eval harness & 兼容性矩阵 |
...
通过 [GitHub Sponsors](https://github.com/sponsors/tayiic) 支持本项目
...
| 安全模型 | [security/README.md](security/README.md) |
| 命令规则 | [security/COMMAND_RULES.md](security/COMMAND_RULES.md) |
| 全局约束 | [security/GLOBAL_CONSTRAINTS.md](security/GLOBAL_CONSTRAINTS.md) |
...
**如果你相信 skill 应该被锻造而非堆砌，欢迎点亮 star ⚡**
